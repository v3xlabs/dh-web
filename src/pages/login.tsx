...
const Text = styled.div`
    ...
    a:visited {text-decoration: none; color: ${({ theme }) => theme.palette.primary[300]};}
    a:hover{color: ${({ theme }) => theme.palette.primary[200]};}
`;
    ...
    return (
        <>
            ...
            <Footer>
                ...
                <Text><a href="https://github.com/dogehousetv/web/issues">Report a bug</a></Text>
                ...
                <DiscordIcon>   
                    ...
                    ><a href="https://discord.gg/gRKx5kcJtZ">
                ...
                <GithubIcon>
                    ...
                    ><a href="https://github.com/dogehousetv">
